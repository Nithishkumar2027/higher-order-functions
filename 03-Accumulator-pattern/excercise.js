...
things.forEach(thing => newCopiedThings.push(thing))
console.log(copiedThings);
console.log(newCopiedThings);
...
numbers_2.forEach(num => newDoubled.push(num * 2))
...
all_numbers.forEach(num => {
    num % 2 === 0 ? newEvenNumbers.push(num) : null
})
